...
def get_user_input():
    print(
        'Welcome to the plant suggestion tool. Please answer the following questions to find your perfect plant match.')
    ...
    input_preference = input(
        'Do you have a preference for a certain type of plant? (Palm, Orchid, Aglaonema, Ficus elastica, Dracaena): ')
